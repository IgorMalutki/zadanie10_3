...
$(function(){
	...
	$("#slidebar ul li").tooltip({
		items: "li",
		content: function() {
			var mouseOverPosition = $(this).index();
			switch (mouseOverPosition) {
				...
				case 1:
					...
					break;	
				case 2:
					return "<img src=https://cdn.pixabay.com/photo/2017/08/31/14/51/emotions-2700972__340.jpg height='100' width='150'/>";
					break;
				case 3:
					return "<img src=https://cdn.pixabay.com/photo/2017/09/01/20/23/ford-2705402__340.jpg height='100' width='150'/>";
					break;
				case 4:
					return "<img src=https://cdn.pixabay.com/photo/2017/09/07/08/17/plums-2724160__340.jpg height='100' width='150'/>";
					break;
				case 5:
					return "<img src=https://cdn.pixabay.com/photo/2017/01/14/13/59/castelmezzano-1979546__340.jpg height='100' width='150'/>";
					break;
			}	
		}
    });
